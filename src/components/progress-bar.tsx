...
export default function ProgressBar({ percentage, amenity }: { percentage: number, amenity: string }) {
    ...
    // 
    return (
        <div className={`custom-accordion__legend bg-[${colorMapping.get(amenity)}]`}></div>
    );
}