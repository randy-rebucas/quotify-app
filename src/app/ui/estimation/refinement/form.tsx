...
export default function Form({
  ...
  const getProjectAmenitiesIdByProjectId = useProjectAmenityStore(
    (state) => state.getProjectAmenitiesIdByProjectId
  );

  useEffect(() => {
    getProjectAmenitiesIdByProjectId(project_id);
  }, [getProjectAmenitiesIdByProjectId, project_id]);
                  ...
                  {refinements.map((refinement: IRefinement, index: number) => (
                    ...
                    >
                      ...
                      <div className="js-sub-step hidden pt-3">
                        <SubMenu projectAmenities={projectAmenities} />
                      </div>
...
export function SubMenu({ projectAmenities }: { projectAmenities: any }) {
  return (
    <>
      {projectAmenities &&
