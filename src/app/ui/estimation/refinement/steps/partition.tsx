...
export default function Partition({
    ...
    const projectAmenities = useProjectAmenityStore(state => state.projectAmenities);
    const getProjectAmenities = useProjectAmenityStore(state => state.getProjectAmenities);
