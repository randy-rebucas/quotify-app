                ...
                {refinementLevels.map((refinementLevel: any, index: number) => (
                    <div data-value={refinementLevel.level} data-col={index + 1} key={refinementLevel._id.toString()}
                        ...
                        <div className="p-30 estimation">
                            <input type="radio" name="refinement" value={refinementLevel._id.toString()} id={`refinement-${index + 1}`} onChange={e => handleRadioChange(index, e)} checked={stimates[tabiIndex].refinement.flooring == refinementLevel._id.toString()} />
