            ...
            {requirementData.map((finish: finishType, index: any) => (
                <div data-col={index + 1} key={finish.id}
                    ...
                    <div className="p-30 estimation">
                        <input type="radio" name="finish" value={finish.slug} id={`finish-${index + 1}`} onChange={e => handleRadioChange(index, e)} checked={stimates[tabiIndex].requirement.buildingCondition == finish.slug}/>
