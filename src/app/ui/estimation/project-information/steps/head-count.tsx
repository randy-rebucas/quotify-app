...
type HeadCountFormProps = HeadCountData & {
    updateFields: (fields: Partial<HeadCountData>) => void
}
                        ...
                        <div className="flex flex-col justify-between h-full">
                            <div>
                                <div className="pt-[25.926vh] w-full">
                                    ...
                                    <div className="custom-input flex flex-col justify-start mt-[5.556vh]">
                                        <input className="bg-transparent focus:outline-none border-b-2 border-blue" type="number" name="averageAttendance"
                                            min={10} max={100}
                                    ...
                                    <div className="flex flex-col items-start justify-center w-full">
                                        <div className="custom-range-slider mt-[5.556vh] relative w-full">
                                            <input id="small-range" type="range"
                                                ...
                                                max={100}
                                                step={10}
                                                value={assignedSeat} onChange={e => updateFields({ assignedSeat: e.target.value })}
