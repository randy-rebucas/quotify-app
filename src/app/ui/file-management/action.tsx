...
export default function Action({ isMore, onClick }: { isMore: boolean, onClick: MouseEventHandler<HTMLAnchorElement> }) {
    return (
        <div className="js-wrapper__more wrapper__more row-start-2">
            <div className="col-span-4">
                <Link href="" onClick={onClick}>
                    ...
                    <div className="js-wrapper__more-text pl-3">{isMore ? 'less' : 'more'}</div>
                </Link>
            </div>
        </div>
    )
