...
import { deleteRefinementLevel } from '@/app/actions/refinementLevel';
...
export async function Delete({ id }: { id: string }) {
  const deleteRefinementLevelWithId = deleteRefinementLevel.bind(null, id);

  return (
    <form action={deleteRefinementLevelWithId}>
