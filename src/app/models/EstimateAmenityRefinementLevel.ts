...
const schema = new Schema<IEstimateAmenityRefinementLevel>({
  ...
  projectAmenity: { type: Schema.Types.ObjectId, ref: "ProjectAmenities", required: true },
});

// 3. Create a Model.
const EstimateAmenityRefinementLevel =
  mongoose.models.EstimateAmenityRefinementLevels ??
  mongoose.model<IEstimateAmenityRefinementLevel>("EstimateAmenityRefinementLevels", schema);
